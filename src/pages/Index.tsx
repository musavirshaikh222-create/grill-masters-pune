...
import heroVideo from "@/assets/hero-bbq.mp4"; // ✅ replace with your actual MP4 filename
  ...
  const features = [
    {
      ...
      description:
        "Enjoy unlimited grilling at your table with premium quality ingredients",
    },
    {
      icon: Users,
      title: "Family Friendly",
      description:
        "Perfect ambience for families, friends, and corporate gatherings",
    },
    {
      icon: Star,
      title: "Premium Quality",
      description:
        "Top-quality food with exceptional service and presentation",
    },
    {
      icon: Clock,
      title: "Open Daily",
      description:
        "Serving delicious buffet from 12 PM to 11 PM every day",
    },
  ];
        ...
        <div className="container mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground animate-fade-in stagger-1">
              At Barbeque Experts, we bring you an unparalleled dining experience
              with unlimited barbeque buffet, live grill at your table, and a
              perfect blend of Indian, Mughlai, and Chinese cuisines. Located at
              Dhanori Jakatnaka, Lohegaon, we serve food lovers across Pune with
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/90 to-transparent flex items-end">
                <div className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    Endless variety of dishes to satisfy every craving
                  </p>
                </div>
              </div>
            </div>
            <div className="relative h-[400px] rounded-lg overflow-hidden group animate-slide-in-right">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/90 to-transparent flex items-end">
                <div className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    Elegant dining experience for every occasion
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-primary/20 to-accent/20">
        <div className="container mx-auto text-center">
          ...
          <Button
            asChild
            size="lg"
            className="text-lg px-8 animate-scale-in stagger-2 hover-lift"
          >
