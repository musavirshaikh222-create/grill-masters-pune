  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!name || !email || !message) {
      toast({
        ...
        description: "Please fill Name, Email, and Message before submitting.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      // Note: using no-cors prevents browser CORS errors but you won't get a readable response.
      // If you later add a server proxy, remove mode: "no-cors" and handle the response.
      ...
      // Assume success if no network exception thrown (no-cors hides response)
      toast({
        title: "Message Sent!",
      ...
      toast({
        title: "Error",
        description: "Something went wrong while sending your message. Try again later.",
        variant: "destructive",
      });
    }
  };
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <Card className="bg-gradient-to-br from-primary/20 to-accent/20 border-primary">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">Chat with us for instant assistance</p>
